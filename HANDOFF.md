...
- 将开场的 3D 写实光锥动画彻底重构为极具 P3R/P5 张力的“黑白红 Pop-Art 扁平漫画光剑”。
- 增加红黑放射状速度线（Speedlines）作为打光退场背景，并增加高速持续旋转动画。
- 修复了欢迎语文字散开后黑色边框依然残留的问题，使其同步粉碎消失。
- 清理了主页多余的赛博朋克平移背景动图，保持极致干净的暗红背景与 P5 半调网点。
- 将以上所有改动提交并推送至 GitHub 远程仓库。
